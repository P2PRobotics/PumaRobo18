...
public final class MotorTest2 extends OpMode {
    ...
    public void loop(){
        ...
        //////////////////////////// its nice to be on this team
        //rmotor1.setPower(5);
        //rmotor2.setPower(5);
        telemetry.update();

        double turningSpeed = adjustedSpeed(errorProportion(45,angles.firstAngle));
        turnTo(45, turningSpeed);
    ...
    public void turnRight(double power) {
        rmotor1.setPower(-power);
        rmotor2.setPower(power);
        lmotor1.setPower(-power);
        lmotor2.setPower(power);
    }
