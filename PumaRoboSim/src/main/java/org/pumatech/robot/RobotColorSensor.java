...
public class RobotColorSensor extends Polygon {
    ...
    public RobotColorSensor(Attachment attachment, double direction, PhysicsEngine engine, ColorSensor colorSensor, Vec2[] vertices, Material mat) {
        super(vertices, mat);
