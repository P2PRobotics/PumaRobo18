...
public class Robot2017 implements Robot {
    ...
    public Robot2017(Vec2 pos, PhysicsEngine engine) {
        Vec2[] vertices = { new Vec2(9, 9), new Vec2(-9, 9), new Vec2(-9, -9), new Vec2(9, -9) };
        chassis = new Polygon(vertices, Material.WOOD1);
        ...
        rangeSensor = new SimModernRoboticsI2cRangeSensor(chassis.getAttachment(pos.added(new Vec2(7, -9))), 0, engine);
        hardwareMap.put("range", rangeSensor);
