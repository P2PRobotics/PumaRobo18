...
package org.pumatech.robotcore.hardware.modernrobotics;
...
public class SimModernRoboticsI2cRangeSensor implements HardwareDevice {
    ...
    public SimModernRoboticsI2cRangeSensor(Attachment attachment, double direction, PhysicsEngine engine) {
